...
\begin{eqnarray*}
     ...
     %
            g .  F \ensuremath{\conj{\Varid{alice}}{\Varid{bob}}} = \ensuremath{\conj{\Varid{alice}\comp \mathbf{in}\;}{\Varid{bob}\comp \mathbf{in}\;}}
     %
     \just\equiv{Universal-$\times$ (6)}
     %
     \ensuremath{\begin{lcbr}\p1\comp \Varid{g}\comp \Conid{F}\;\conj{\Varid{alice}}{\Varid{bob}}\mathrel{=}\Varid{alice}\comp \mathbf{in}\;\\\p2\comp \Varid{g}\comp \Conid{F}\;\conj{\Varid{alice}}{\Varid{bob}}\mathrel{=}\Varid{bob}\comp \mathbf{in}\;\end{lcbr}}
     %
     \just\equiv{Fokkinga (52)}
     %
          \ensuremath{\cata{\conj{\p1\comp \Varid{g}}{\p2\comp \Varid{g}}}}  = \ensuremath{\conj{\Varid{alice}}{\Varid{bob}}}
     %
     \qed
\end{eqnarray*}
