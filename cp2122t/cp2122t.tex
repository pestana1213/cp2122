...
Fig.~\ref{fig:sierp1}.\footnote{O resultado é gravado no ficheiro \text{\tt \char95{}\char46{}html}, que pode 
...
\\
\>[B]{}\Varid{enc}\;\Varid{c}\mathrel{=}\Varid{tobin}\;(\Varid{ord}\;\Varid{c}\mathbin{-}\Varid{ord}\;\text{\tt 'A'}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
e descodificação,
\begin{hscode}\SaveRestoreHook
...
\\
\>[B]{}\Varid{dec}\;\Varid{b}\mathrel{=}\Varid{chr}\;(\Varid{frombin}\;\Varid{b}\mathbin{+}\Varid{ord}\;\text{\tt 'A'}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
onde \ensuremath{\Varid{tobin}} e \ensuremath{\Varid{frombin}} são funções dadas no anexo \ref{sec:codigo}. Por exemplo,
\begin{quote}
\ensuremath{\Varid{enc}\;\text{\tt 'A'}\mathrel{=}[\mskip1.5mu \mathrm{0},\mathrm{0},\mathrm{0},\mathrm{0},\mathrm{0}\mskip1.5mu]}
\\
\ensuremath{\Varid{enc}\;\text{\tt 'B'}\mathrel{=}[\mskip1.5mu \mathrm{0},\mathrm{0},\mathrm{0},\mathrm{0},\mathrm{1}\mskip1.5mu]}
\\ $\vdots$ \\
\ensuremath{\Varid{enc}\;\text{\tt 'Z'}\mathrel{=}[\mskip1.5mu \mathrm{1},\mathrm{1},\mathrm{0},\mathrm{0},\mathrm{1}\mskip1.5mu]}
\end{quote}
Embora \ensuremath{\Varid{dec}} e \ensuremath{\Varid{enc}} sejam inversas uma da outra, para o intervalo de \ensuremath{\text{\tt 'A'}}
a \ensuremath{\text{\tt 'Z'}}, deixam de o ser quando, a meio da transmissão, acontecem bit-flips: 
...
\ColumnHook
\end{hscode}\resethooks
Por exemplo, \ensuremath{\Varid{transmit}\;\text{\tt 'H'}} irá dar a seguinte distribuição:
\begin{quote}\small
\begin{tabbing}\tt
~~\char39{}H\char39{}~~67\char46{}2\char37{}\char13{}\\
\tt ~~\char39{}D\char39{}~~~7\char46{}5\char37{}\char13{}\\
\tt ~~\char39{}F\char39{}~~~7\char46{}5\char37{}\char13{}\\
\tt ~~\char39{}G\char39{}~~~7\char46{}5\char37{}\char13{}\\
\tt ~~\char39{}P\char39{}~~~2\char46{}8\char37{}\char13{}\\
\tt ~~\char39{}X\char39{}~~~2\char46{}8\char37{}\char13{}\\
\tt ~~\char39{}E\char39{}~~~0\char46{}8\char37{}\char13{}\\
\tt ~~\char39{}B\char39{}~~~0\char46{}8\char37{}\char13{}\\
\tt ~~\char39{}C\char39{}~~~0\char46{}8\char37{}\char13{}\\
\tt ~~\char39{}L\char39{}~~~0\char46{}3\char37{}\char13{}\\
\tt ~~\char39{}N\char39{}~~~0\char46{}3\char37{}\char13{}\\
\tt ~~\char39{}O\char39{}~~~0\char46{}3\char37{}\char13{}\\
\tt ~~\char39{}T\char39{}~~~0\char46{}3\char37{}\char13{}\\
\tt ~~\char39{}V\char39{}~~~0\char46{}3\char37{}\char13{}\\
\tt ~~\char39{}W\char39{}~~~0\char46{}3\char37{}\char13{}\\
\tt ~~\char39{}\char96{}\char39{}~~~0\char46{}1\char37{}\char13{}\\
\tt ~~\char39{}A\char39{}~~~0\char46{}1\char37{}\char13{}
\end{tabbing}
\end{quote}
...
Se agora a transmissão do \ensuremath{\text{\tt 'H'}} for feita em triplicado,
usando
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\begin{quote}\small
\begin{tabbing}\tt
~Main\char62{}~transmit3~\char39{}H\char39{}\char13{}\\
\tt ~~\char39{}H\char39{}~~91\char46{}0\char37{}\char13{}\\
\tt ~~\char39{}F\char39{}~~~2\char46{}6\char37{}\char13{}\\
\tt ~~\char39{}G\char39{}~~~2\char46{}6\char37{}\char13{}\\
\tt ~~\char39{}D\char39{}~~~2\char46{}6\char37{}\char13{}\\
\tt ~~\char39{}P\char39{}~~~0\char46{}4\char37{}\char13{}\\
\tt ~~\char39{}X\char39{}~~~0\char46{}4\char37{}\char13{}\\
\tt ~~\char39{}B\char39{}~~~0\char46{}1\char37{}\char13{}\\
\tt ~~\char39{}C\char39{}~~~0\char46{}1\char37{}\char13{}\\
\tt ~~\char39{}E\char39{}~~~0\char46{}1\char37{}\char13{}
\end{tabbing}
\end{quote}
...
\\
\>[B]{}d_1 \mathrel{=}\Conid{D}\;[\mskip1.5mu (\text{\tt 'A'},\mathrm{0.02}),(\text{\tt 'B'},\mathrm{0.12}),(\text{\tt 'C'},\mathrm{0.29}),(\text{\tt 'D'},\mathrm{0.35}),(\text{\tt 'E'},\mathrm{0.22})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}d_2 \mathrel{=}\Varid{uniform}\;(\Varid{words}\;\text{\tt \char34 Uma~frase~de~cinco~palavras\char34}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
isto é
\begin{Verbatim}[fontsize=\small]
...
\begin{eqnarray*}
     ...
     \just\equiv{Lei da troca (28)}
     %
          \ensuremath{\conj{(\Varid{q}\;\Varid{d})}{\conj{(\Varid{r}\;\Varid{d})}{(\Varid{c}\;\Varid{d})}}\mathrel{=}\cata{\alt{\cdot }{\cdot }}\;\conj{\underline{\mathrm{0}}}{\conj{\underline{\mathrm{0}}}{\underline{\Varid{d}}}}\;(\conj{h_2 }{\conj{k_2 }{l_2 }})}
     %
     \just\equiv{for b i = \ensuremath{\cata{\alt{\underline{\Varid{i}}}{\Varid{b}}}}}
     %
          \ensuremath{\for{(h_2 ,(k_2 ,l_2 ))}\ {(\mathrm{0},(\mathrm{0},\Varid{d}))}}
     %
     \qed
\end{eqnarray*}
...
\column{6}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[6]{}\Varid{both}\mathbin{::}\Conid{Ord}\;\Varid{d}\Rightarrow {\LTree}\;\Varid{d}\to (\Varid{d},\Varid{d}){}\<[E]%
\\
\>[6]{}\Varid{both}\mathrel{=}\llparenthesis\, \Varid{g}\,\rrparenthesis{}\<[E]%
\\
\>[6]{}\Varid{g}\mathrel{=}\alt{\Varid{g11}}{\Varid{g12}}{}\<[E]%
\\
\>[6]{}\Varid{g11}\;\Varid{x}\mathrel{=}(\Varid{x},\Varid{x}){}\<[E]%
\\
\>[6]{}\Varid{g12}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{a}\mathbin{+}\Varid{c},\Varid{b}\mathbin{+}\Varid{d}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
     ...
     %
          \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{alice}\;(i_1\;\Varid{z})\mathrel{=}\p1\;(\Varid{z},\Varid{z})\\\Varid{alice}\;(i_2\;(\Varid{x},\Varid{y}))\mathrel{=}\p1\;((\Varid{alice}\;\Varid{x})\mathbin{+}(\Varid{alice}\;\Varid{y}),(\Varid{bob}\;\Varid{x})\mathbin{+}(\Varid{bob}\;\Varid{y}))\end{lcbr}\\\begin{lcbr}\Varid{bob}\;(i_1\;\Varid{z})\mathrel{=}\p2\;(\Varid{z},\Varid{z})\\\Varid{bob}\;(i_2\;(\Varid{x},\Varid{y}))\mathrel{=}\p2\;((\Varid{alice}\;\Varid{x})\mathbin{+}(\Varid{alice}\;\Varid{y}),(\Varid{bob}\;\Varid{x})\mathbin{+}(\Varid{bob}\;\Varid{y}))\end{lcbr}\end{lcbr}}
     %
     \just\equiv{Def-proj (79)}
     %
          \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{alice}\;(i_1\;\Varid{z})\mathrel{=}\Varid{z}\\\Varid{alice}\;(i_2\;(\Varid{x},\Varid{y}))\mathrel{=}(\Varid{alice}\;\Varid{x})\mathbin{+}(\Varid{alice}\;\Varid{y})\end{lcbr}\\\begin{lcbr}\Varid{bob}\;(i_1\;\Varid{z})\mathrel{=}\Varid{z}\\\Varid{bob}\;(i_2\;(\Varid{x},\Varid{y}))\mathrel{=}(\Varid{bob}\;\Varid{x})\mathbin{+}(\Varid{bob}\;\Varid{y})\end{lcbr}\end{lcbr}}
     %
     \qed
\end{eqnarray*}
...
\begin{eqnarray*}
     ...
     %
          \ensuremath{\Varid{outLTree3}\comp \alt{\Conid{Tri}}{\Conid{Nodo}}} = id
     %
     \just\equiv{Fusão-+ (20)}
     %
...
\>[27]{}i_2\;\Varid{t}\;\Varid{y}\;\Varid{z}{}\<[E]%
\\[\blanklineskip]%
...
\begin{eqnarray*}
     \xymatrix@C=1cm@R=2cm{
         \ensuremath{\Conid{Ltree3}\;\Conid{A}}
         \ar[d]_{\ensuremath{\llparenthesis\, \Varid{f}\,\rrparenthesis}}\ar@/^1.5pc/[rr]^(0.5){out} 
     & 
          \cong
     &
         \ensuremath{\Conid{A}\mathbin{+}\Conid{Ltree3}\;\Conid{A}\times\Conid{Ltree3}\;\Conid{A}}
                \ar[d]^{recLTree3 (cataLtree3 f)}
                \ar@/^1.5pc/[ll]^(0.5){in}
     \\
          \ensuremath{\Conid{A}} && \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times\Conid{A}}
          \ar[ll]^{\ensuremath{\Varid{f}}}
     }
\end{eqnarray*}
...
\column{6}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}g_1 \mathrel{=}(\Varid{singl}\;\alt{\cdot }{\cdot }\;(\mathsf{conc}\mathbin{·}(\Varid{id}\mathbin{*}\mathsf{conc})))\;\mathbf{where}\;\mathsf{conc}\;(l_1 ,(l_2 ,\Varid{l3}))\mathrel{=}l_1 \mathbin{+\!\!\!+}l_2 \mathbin{+\!\!\!+}\Varid{l3}{}\<[E]%
\\[\blanklineskip]%
