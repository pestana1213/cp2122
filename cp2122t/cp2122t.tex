...
\begin{eqnarray*}
     ...
     %
             \ensuremath{\begin{lcbr}(\Varid{q}\;\Varid{d})\;\mathrm{0}\mathrel{=}\mathrm{0}\\(\Varid{q}\;\Varid{d})\;(\succ \;\Varid{n})\mathrel{=}(\Varid{q}\;\Varid{d})\;\Varid{n}\mathbin{+}\mathbf{if}\;(((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d})))\;\Varid{n}\;\mathbf{then}\;\underline{\mathrm{1}}\;\Varid{n}\;\mathbf{else}\;\underline{\mathrm{0}}\;\Varid{n}\end{lcbr}}
     %
     \just\equiv{Def-comp (72), Def-cond (78)}
     %
             \ensuremath{\begin{lcbr}(\Varid{q}\;\Varid{d})\;\mathrm{0}\mathrel{=}\mathrm{0}\\((\Varid{q}\;\Varid{d})\comp \succ )\;\Varid{n}\mathrel{=}(\Varid{q}\;\Varid{d})\;\Varid{n}\mathbin{+}((\mathrm{0}\equiv )\comp (\Varid{cd})\Rightarrow\underline{\mathrm{1}},\underline{\mathrm{0}})\;\Varid{n}\end{lcbr}}
     %
     ...
     %
             \ensuremath{\begin{lcbr}(\Varid{q}\;\Varid{d})\comp \underline{\mathrm{0}}\;\Varid{n}\mathrel{=}\underline{\mathrm{0}}\;\Varid{n}\\((\Varid{q}\;\Varid{d})\comp \succ )\;\Varid{n}\mathrel{=}\uncurry{(\mathbin{+})}\comp ((\Varid{q}\;\Varid{d})\;\Varid{n},((\mathrm{0}\equiv )\comp (\Varid{cd})\Rightarrow\underline{\mathrm{1}},\underline{\mathrm{0}})\;\Varid{n})\end{lcbr}}
     %
...
\begin{eqnarray*}
     ...
     \just\equiv{Def-const (74), $\forall \ x \  (c \ d) \ x \ensuremath{\equiv } 0 \  \equiv \  \forall \ x \ (c \ d) \ x \ (\ensuremath{\equiv } 0) \  \equiv \ \forall \ x \ (0 \ensuremath{\equiv }) \ . \ (c \ d) \ x \ \equiv \ \forall \ x \ ((0 \ensuremath{\equiv }) \ . \ (c \ d))$}
     %
                  \ensuremath{\begin{lcbr}(\Varid{r}\;\Varid{d})\comp \underline{\mathrm{0}}\;\Varid{n}\mathrel{=}\underline{\mathrm{0}}\;\Varid{n}\\(\Varid{r}\;\Varid{d})\;(\succ \;\Varid{n})\mathrel{=}\mathbf{if}\;((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}))\;\Varid{n}\;\mathbf{then}\;\underline{\mathrm{0}}\;\Varid{n}\;\mathbf{else}\;\underline{\mathrm{1}}\;\Varid{n}\mathbin{+}(\Varid{r}\;\Varid{d})\;\Varid{n}\end{lcbr}}
     %
     \just\equiv{Uncurry (84), Def-comp (72)}
     %
                  \ensuremath{\begin{lcbr}(\Varid{r}\;\Varid{d})\comp \underline{\mathrm{0}}\;\Varid{n}\mathrel{=}\underline{\mathrm{0}}\;\Varid{n}\\((\Varid{r}\;\Varid{d})\comp \succ )\;\Varid{n}\mathrel{=}\mathbf{if}\;((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}))\;\Varid{n}\;\mathbf{then}\;\underline{\mathrm{0}}\;\Varid{n}\;\mathbf{else}\;\uncurry{(\mathbin{+})}\comp (\underline{\mathrm{1}}\;\Varid{n},(\Varid{r}\;\Varid{d})\;\Varid{n})\end{lcbr}}
     %
     \just\equiv{Def-split (76)}
     %
...
\begin{eqnarray*}
     ...
     %
           \ensuremath{\alt{\Varid{g11}}{\Varid{g12}\times\conj{\Varid{alice}}{\Varid{bob}}}} = \ensuremath{\conj{\Varid{alice}}{\Varid{bob}}\comp \alt{\Conid{Leaf}}{\Conid{Fork}}}
     %
     \just\equiv{Fusão-+ (20)}
     %
           \ensuremath{\alt{\Varid{g11}}{\Varid{g12}\times\conj{\Varid{alice}}{\Varid{bob}}}} = 
           \ensuremath{\alt{\conj{\Varid{alice}}{\Varid{bob}}\comp \Conid{Leaf}}{\conj{\Varid{alice}}{\Varid{bob}}\comp \Conid{Fork}}}
     %
     \just\equiv{Def-x (10)}
     %
           \ensuremath{\alt{\Varid{g11}}{(\conj{\Varid{g12}\comp \pi \;\mathrm{1}}{\conj{\Varid{alice}}{\Varid{bob}}\comp \pi \;\mathrm{2}})}} = 
           \ensuremath{\alt{\conj{\Varid{alice}}{\Varid{bob}}\comp \Conid{Leaf}}{\conj{\Varid{alice}}{\Varid{bob}}\comp \Conid{Fork}}}
     %
     \just\equiv{Fusão-x (9)}
     %
           \ensuremath{\alt{\Varid{g11}}{(\conj{\Varid{g12}\comp \pi \;\mathrm{1}}{(\conj{\Varid{alice}\comp \pi \;\mathrm{2}}{\Varid{bob}\comp \pi \;\mathrm{2}})})}} = 
           \ensuremath{\alt{(\conj{\Varid{alice}\comp \Conid{Leaf}}{\Varid{bob}\comp \Conid{Leaf}})}{(\conj{\Varid{alice}\comp \Conid{Fork}}{\Varid{bob}\comp \Conid{Fork}})}}
     %
     \just\equiv{Eq-+ (27)}
     %
               \ensuremath{\begin{lcbr}\Varid{g11}\mathrel{=}\conj{\Varid{alice}\comp \Conid{Leaf}}{\Varid{bob}\comp \Conid{Leaf}}\\\conj{\Varid{g12}\comp \pi \;\mathrm{1}}{(\conj{\Varid{alice}\comp \pi \;\mathrm{2}}{\Varid{bob}\comp \pi \;\mathrm{2}})}\mathrel{=}\conj{\Varid{alice}\comp \Conid{Fork}}{\Varid{bob}\comp \Conid{Fork}}\end{lcbr}} 
     %
     \just\equiv{Eq-x (16)}
     %
               \ensuremath{\begin{lcbr}\Varid{g11}\mathrel{=}\conj{\Varid{alice}\comp \Conid{Leaf}}{\Varid{bob}\comp \Conid{Leaf}}\\\Varid{g12}\comp \pi \;\mathrm{1}\mathrel{=}\Varid{alice}\comp \Conid{Fork}\\\conj{\Varid{alice}\comp \pi \;\mathrm{2}}{\Varid{bob}\comp \pi \;\mathrm{2}}\mathrel{=}\Varid{bob}\comp \Conid{Fork}\end{lcbr}}
     %
     \just\equiv{Universal-x (6)}
     %
               \ensuremath{\begin{lcbr}\begin{lcbr}\pi \;\mathrm{1}\comp \Varid{g11}\mathrel{=}\Varid{alice}\comp \Conid{Leaf}\\\pi \;\mathrm{2}\comp \Varid{g11}\mathrel{=}\Varid{bob}\comp \Conid{Leaf}\end{lcbr}\\\Varid{g12}\comp \pi \;\mathrm{1}\mathrel{=}\Varid{alice}\comp \Conid{Fork}\\\begin{lcbr}\pi \;\mathrm{1}\comp \Varid{bob}\comp \Conid{Fork}\mathrel{=}\Varid{alice}\comp \pi \;\mathrm{2}\\\pi \;\mathrm{2}\comp \Varid{bob}\comp \Conid{Fork}\mathrel{=}\Varid{bob}\comp \pi \;\mathrm{2}\end{lcbr}\end{lcbr}}
     %
     \just\equiv{Igualdade extensional (71)}
     %
               \ensuremath{\begin{lcbr}\begin{lcbr}(\pi \;\mathrm{1}\comp \Varid{g11})\;\Varid{x}\mathrel{=}(\Varid{alice}\comp \Conid{Leaf})\;\Varid{x}\\(\pi \;\mathrm{2}\comp \Varid{g11})\;\Varid{x}\mathrel{=}(\Varid{bob}\comp \Conid{Leaf})\;\Varid{x}\end{lcbr}\\(\Varid{g12}\comp \pi \;\mathrm{1})\;(\Varid{y},\Varid{z})\mathrel{=}(\Varid{alice}\comp \Conid{Fork})\;(\Varid{y},\Varid{z})\\\begin{lcbr}(\pi \;\mathrm{1}\comp \Varid{bob}\comp \Conid{Fork})\;(\Varid{y},\Varid{z})\mathrel{=}(\Varid{alice}\comp \pi \;\mathrm{2})\;(\Varid{y},\Varid{z})\\(\pi \;\mathrm{2}\comp \Varid{bob}\comp \Conid{Fork})\;(\Varid{y},\Varid{z})\mathrel{=}(\Varid{bob}\comp \pi \;\mathrm{2})\;(\Varid{y},\Varid{z})\end{lcbr}\end{lcbr}}
     %
     \just\equiv{Def-comp (72)}
     %
               \ensuremath{\begin{lcbr}\begin{lcbr}\pi \;\mathrm{1}\;(\Varid{g11}\;\Varid{x})\mathrel{=}\Varid{alice}\;(\Conid{Leaf}\;\Varid{x})\\\pi \;\mathrm{2}\;(\Varid{g11}\;\Varid{x})\mathrel{=}\Varid{bob}\;(\Conid{Leaf}\;\Varid{x})\end{lcbr}\\\Varid{g12}\;(\pi \;\mathrm{1}\;(\Varid{y},\Varid{z}))\mathrel{=}\Varid{alice}\;(\Conid{Fork}\;(\Varid{y},\Varid{z}))\\\begin{lcbr}\pi \;\mathrm{1}\;((\Varid{bob}\comp \Conid{Fork})\;(\Varid{y},\Varid{z}))\mathrel{=}\Varid{alice}\;(\pi \;\mathrm{2}\;(\Varid{y},\Varid{z}))\\\pi \;\mathrm{2}\;((\Varid{bob}\comp \Conid{Fork})\;(\Varid{y},\Varid{z}))\mathrel{=}\Varid{bob}\;(\pi \;\mathrm{2}\;(\Varid{y},\Varid{z}))\end{lcbr}\end{lcbr}}
     %
     \just\equiv{Def-comp (72)}
     %
               \ensuremath{\begin{lcbr}\begin{lcbr}\pi \;\mathrm{1}\;(\Varid{g11}\;\Varid{x})\mathrel{=}\Varid{alice}\;(\Conid{Leaf}\;\Varid{x})\\\pi \;\mathrm{2}\;(\Varid{g11}\;\Varid{x})\mathrel{=}\Varid{bob}\;(\Conid{Leaf}\;\Varid{x})\end{lcbr}\\\Varid{g12}\;(\pi \;\mathrm{1}\;(\Varid{y},\Varid{z}))\mathrel{=}\Varid{alice}\;(\Conid{Fork}\;(\Varid{y},\Varid{z}))\\\begin{lcbr}\pi \;\mathrm{1}\;(\Varid{bob}\;(\Conid{Fork}\;(\Varid{y},\Varid{z})))\mathrel{=}\Varid{alice}\;(\pi \;\mathrm{2}\;(\Varid{y},\Varid{z}))\\\pi \;\mathrm{2}\;(\Varid{bob}\;(\Conid{Fork}\;(\Varid{y},\Varid{z})))\mathrel{=}\Varid{bob}\;(\pi \;\mathrm{2}\;(\Varid{y},\Varid{z}))\end{lcbr}\end{lcbr}}
     %
     \just\equiv{Definição de g11}
     %
               \ensuremath{\begin{lcbr}\begin{lcbr}\pi \;\mathrm{1}\;(\Varid{x},\Varid{x})\mathrel{=}\Varid{alice}\;(\Conid{Leaf}\;\Varid{x})\\\pi \;\mathrm{2}\;(\Varid{x},\Varid{x})\mathrel{=}\Varid{bob}\;(\Conid{Leaf}\;\Varid{x})\end{lcbr}\\\Varid{g12}\;(\pi \;\mathrm{1}\;(\Varid{y},\Varid{z}))\mathrel{=}\Varid{alice}\;(\Conid{Fork}\;(\Varid{y},\Varid{z}))\\\begin{lcbr}\pi \;\mathrm{1}\;(\Varid{bob}\;(\Conid{Fork}\;(\Varid{y},\Varid{z})))\mathrel{=}\Varid{alice}\;(\pi \;\mathrm{2}\;(\Varid{y},\Varid{z}))\\\pi \;\mathrm{2}\;(\Varid{bob}\;(\Conid{Fork}\;(\Varid{y},\Varid{z})))\mathrel{=}\Varid{bob}\;(\pi \;\mathrm{2}\;(\Varid{y},\Varid{z}))\end{lcbr}\end{lcbr}}
     \qed
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inLTree3}\mathrel{=}[\mskip1.5mu \Conid{Tri},\Conid{Nodo}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{outLTree3}\;(\Conid{Nodo}\;\Varid{t}\;\Varid{y}\;\Varid{z})\mathrel{=}{}\<[27]%
\>[27]{}i_1\;\Varid{t}\;\Varid{y}\;\Varid{z}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseLTree3}\;\Varid{f}\;\Varid{g}\mathrel{=}{}\<[19]%
\>[19]{}\Varid{g}\mathbin{+}\Varid{f}\mathbin{*}(\Varid{f}\mathbin{*}\Varid{f}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recLTree3}\;\Varid{f}\mathrel{=}\Varid{id}\mathbin{+}\Varid{f}\mathbin{*}(\Varid{f}\mathbin{*}\Varid{f}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataLTree3}\;\Varid{f}\mathrel{=}\Varid{f}\mathbin{·}(\Varid{recLTree3}\;(\Varid{cataLTree3}\;\Varid{f}))\mathbin{·}\Varid{outLTree3}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anaLTree3}\;\Varid{f}\mathrel{=}\Varid{inLTree3}\mathbin{·}(\Varid{recLTree3}\;(\Varid{anaLTree3}\;\Varid{f}))\mathbin{·}\Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloLTree3}\;\Varid{f}\;\Varid{g}\mathrel{=}\Varid{cataLTree3}\;\Varid{f}\mathbin{·}\Varid{anaLTree3}\;\Varid{g}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{6}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}g_1 \mathrel{=}(\Varid{singl}\;\alt{\cdot }{\cdot }\;(\mathsf{conc}\mathbin{·}(\Varid{id}\mathbin{*}\mathsf{conc})))\;\mathbf{where}\;\Varid{conc'}\;(l_1 ,(l_2 ,\Varid{l3}))\mathrel{=}l_1 \mathbin{+\!\!\!+}l_2 \mathbin{+\!\!\!+}\Varid{l3}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t1}\mathrel{=}(((\Varid{x},\Varid{y}),\Varid{s}\mathbin{/}\mathrm{2}),\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t2}\mathrel{=}(((\Varid{x}\mathbin{+}\Varid{s}\mathbin{/}\mathrm{2},\Varid{y}),\Varid{s}\mathbin{/}\mathrm{2}),\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t3}\mathrel{=}(((\Varid{x},\Varid{y}\mathbin{+}\Varid{s}\mathbin{/}\mathrm{2}),\Varid{s}\mathbin{/}\mathrm{2}),\Varid{n}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
