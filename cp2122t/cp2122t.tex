...
\begin{tabbing}\ttfamily
~\char60{}\char40{}q~d\char41{}\char44{}\char60{}\char40{}r~d\char41{}\char44{}\char40{}c~d\char41{}\char62{}\char62{}~\char61{}~for~\char40{}g~d\char41{}~\char40{}0\char44{}\char40{}0\char44{}d\char41{}\char41{}~where~\\
\ttfamily ~~~~~~~~~~~\char40{}g~d\char41{}\char40{}q\char44{}\char40{}r\char44{}c\char41{}\char41{}~\char61{}~\char40{}h2~d~\char40{}q\char44{}\char40{}r\char44{}c\char41{}\char41{}~\char44{}~\char40{}k2~d~\char40{}q\char44{}\char40{}r\char44{}d\char41{}\char41{}\char44{}l2~d~\char40{}q\char44{}\char40{}r\char44{}c\char41{}\char41{}\char41{}\char41{}
\end{tabbing}
...
\begin{tabbing}\ttfamily
~~~~~~\char60{}\char40{}q~d\char41{}\char44{}\char60{}\char40{}r~d\char41{}\char44{}\char40{}c~d\char41{}\char62{}\char62{}~\char61{}~for~\char40{}g~d\char41{}~\char40{}0\char44{}\char40{}0\char44{}d\char41{}\char41{}~where~\\
\ttfamily ~~~~~~~~~~~~~~~\char40{}g~d\char41{}~\char40{}q\char44{}\char40{}r\char44{}0\char41{}\char41{}~\char61{}~\char40{}q\char43{}1\char44{}~\char40{}0\char44{}d\char41{}\char41{}\\
\ttfamily ~~~~~~~~~~~~~~~\char40{}g~d\char41{}~\char40{}q\char44{}\char40{}r\char44{}c\char43{}1\char41{}\char41{}~\char61{}~\char40{}q\char44{}~\char40{}r\char43{}1\char44{}c\char41{}\char41{}
\end{tabbing}
...
\begin{eqnarray*}
     \xymatrix@C=1cm@R=2cm{
         \ensuremath{\Conid{Ltree}\;\Conid{Int}}
         \ar[d]_{\ensuremath{\llparenthesis\, \Varid{g}\,\rrparenthesis}}\ar@/^1.5pc/[rr]^(0.5){out} 
     & 
          \cong
     &
         \ensuremath{\Conid{Int}\mathbin{+}\Conid{Ltree}\;\Conid{Int}\times\Conid{Ltree}\;\Conid{Int}}
                \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{g}\times\Varid{g}}}
                \ar@/^1.5pc/[ll]^(0.5){in}
     \\
          \ensuremath{\Conid{Int}\times\Conid{Int}} && \ensuremath{\Conid{Int}\mathbin{+}\Conid{Int}\times\Conid{Int}} 
                \ar[ll]^{ g  = \ensuremath{\alt{\Varid{g11}}{\Varid{g12}}}}
     }
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{both}\mathrel{=}\llparenthesis\, \Varid{g}\,\rrparenthesis{}\<[E]%
\\
\>[B]{}\Varid{g}\mathrel{=}\alt{\Varid{g11}}{\Varid{g12}}{}\<[E]%
\\
\>[B]{}\Varid{g11}\;\Varid{x}\mathrel{=}(\Varid{x},\Varid{x}){}\<[E]%
\\
\>[B]{}\Varid{g12}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{a}\mathbin{+}\Varid{c},\Varid{b}\mathbin{+}\Varid{d}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{alice}\mathbin{::}\Conid{Num}\;\Varid{c}\Rightarrow {\LTree}\;\Varid{c}\to \Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{alice}\;(\Conid{Leaf}\;\Varid{z})\mathrel{=}\Varid{z}{}\<[E]%
\\
\>[B]{}\Varid{alice}\;(\Conid{Fork}\;(\Varid{x},\Varid{y}))\mathrel{=}(\Varid{alice}\;\Varid{x})\mathbin{+}(\Varid{alice}\;\Varid{y}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bob}\mathbin{::}\Conid{Num}\;\Varid{c}\Rightarrow {\LTree}\;\Varid{c}\to \Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{bob}\;(\Conid{Leaf}\;\Varid{z})\mathrel{=}\Varid{z}{}\<[E]%
\\
\>[B]{}\Varid{bob}\;(\Conid{Fork}\;(\Varid{x},\Varid{y}))\mathrel{=}(\Varid{bob}\;\Varid{x})\mathbin{+}(\Varid{bob}\;\Varid{y}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outLTree3}\;(\Conid{Tri}\;\Varid{x})\mathrel{=}i_1\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{outLTree3}\;(\Conid{Nodo}\;\Varid{t}\;\Varid{y}\;\Varid{z})\mathrel{=}i_2\;((\Varid{t},\Varid{y}),\Varid{z}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseLTree3}\;\Varid{g}\;\Varid{f}\mathrel{=}\Varid{g}+((\Varid{f}\times\Varid{f})\times\Varid{f}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks


Pela propriedade de Base-cata, temos que recLTree3 \ensuremath{\Varid{f}\mathrel{=}\Varid{baseLTree3}\;\Varid{id}\;\Varid{f}\mathrel{=}\Varid{id}\mathbin{+}\Varid{f}\times(\Varid{f}\times\Varid{f})}.
...
Como \ensuremath{\Varid{folhasSierp}\mathrel{=}\llparenthesis\, g_1 \,\rrparenthesis}, o diagrama correspondente a esta função é o seguinte:
\begin{eqnarray*}
     \xymatrix@C=1cm@R=2cm{
         \ensuremath{\Conid{Ltree3}}
         \ar[d]_{\ensuremath{\llparenthesis\, g_1 \,\rrparenthesis}}
         \ar@/^1.5pc/[rr]^(0.5){out} 
     & 
          \cong
     &
         \ensuremath{\Conid{Tri}\mathbin{+}\Conid{Ltree3}\times(\Conid{Ltree3}\times\Conid{Ltree3})}
                \ar[d]^{recLTree3 (cataLtree3 g1)}
                \ar@/^1.5pc/[ll]^(0.5){in}
     \\
          Tri^* && \ensuremath{\Conid{Tri}\mathbin{+}\Conid{Tri}\times\Conid{Tri}\times\Conid{Tri}}
          \ar[ll]^{\ensuremath{g_1 }}
     }
\end{eqnarray*}
...
Relativamente, à função \ensuremath{\Varid{geraSierp}\mathrel{=}\mathopen{[\!(}g_2 \mathclose{)\!]}}, o seu diagrama é o seguinte:
...
\begin{eqnarray*}
     ...
     \\
          ...
          \ar[u]^{\ensuremath{\mathopen{[\!(}\Varid{g}\mathclose{)\!]}}} 
          \ar[r]^(0.35){out_{\ensuremath{\N_0}}} 
          \ar@/_1.5pc/[rr]_(0.5){g2} 
     & 
          \ensuremath{\Conid{Tri}\times\mathrm{1}\mathbin{+}\Conid{Tri}\times\N_0}
          \ar[r]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{f}\times\Varid{g}\times\Varid{h}}}
     &
          \ensuremath{\Conid{Tri}\mathbin{+}\Conid{Tri}\times\Conid{Tri}\times\Conid{Tri}}
          \ar[u]_{recLTree3 (\ensuremath{\Varid{anaLtree3}\;\Varid{g}})}
     }
\end{eqnarray*}
...
Ora, sabemos que um hilomorfismo é a composição de catamorfismo, após um anamorfismo. Logo, o hilomorfismo \ensuremath{\Varid{sierpinski}\mathrel{=}\Varid{folhasSierp}\mathbin{·}\Varid{geraSierp}}, em que \ensuremath{\Varid{folhasSierp}\mathrel{=}\llparenthesis\, g_1 \,\rrparenthesis} e \ensuremath{\Varid{geraSierp}\mathrel{=}\mathopen{[\!(}g_2 \mathclose{)\!]}}, caracteriza-se da seguinte forma:
\begin{eqnarray*}
     \xymatrix@C=2cm@R=2cm{
         \ensuremath{\Conid{Tri}\times\N_0}
         \ar[d]_{\ensuremath{\mathopen{[\!(}\Varid{g}\mathclose{)\!]}}}
         \ar[rr]^{\ensuremath{g_2 }}
     &&
         \ensuremath{\Conid{Tri}\mathbin{+}\Conid{Tri}\times\Conid{Tri}\times\Conid{Tri}}
         \ar[d]^{recLTree3 (\ensuremath{\Varid{anaLTree3}\;\Varid{g}})}
     \\
          \ensuremath{\Conid{Ltree3}}
     ...
     & 
          \cong
     &
          \ensuremath{\Conid{Tri}\mathbin{+}\mathsf{LTree3}\times\Conid{Ltree3}\times\mathsf{LTree3}}
          \ar[d]^{recLTree3 (\ensuremath{\Varid{cataLTree3}\;\Varid{g}})}
          \ar@/^1.5pc/[ll]^(0.5){in}
     \\
         Tri^* 
     && 
...
\\
\>[B]{}g_2 \;(((\Varid{x},\Varid{y}),\Varid{s}),\Varid{n})\mid \Varid{n}\equiv \mathrm{0}\mathrel{=}i_1\;((\Varid{x},\Varid{y}),\Varid{s}){}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mid \Varid{otherwise}\mathrel{=}i_2\;((\Varid{x1},\Varid{y1}),\Varid{s1})\;\mathbf{where}{}\<[E]%
\\
\>[19]{}\hsindent{15}{}\<[34]%
\>[34]{}\Varid{x1}\mathrel{=}(((\Varid{x},\Varid{y}),\Varid{s'}),\Varid{n'}){}\<[E]%
\\
\>[19]{}\hsindent{15}{}\<[34]%
\>[34]{}\Varid{y1}\mathrel{=}(((\Varid{x}\mathbin{+}\Varid{s'},\Varid{y}),\Varid{s'}),\Varid{n'}){}\<[E]%
\\
\>[19]{}\hsindent{15}{}\<[34]%
\>[34]{}\Varid{s1}\mathrel{=}(((\Varid{x},\Varid{y}\mathbin{+}\Varid{s'}),\Varid{s'}),\Varid{n'}){}\<[E]%
\\
\>[19]{}\hsindent{15}{}\<[34]%
\>[34]{}\Varid{s'}\mathrel{=}\Varid{s}\div \mathrm{2}{}\<[E]%
\\
\>[19]{}\hsindent{15}{}\<[34]%
\>[34]{}\Varid{n'}\mathrel{=}\Varid{pred}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

Após definir os genes do hilomorfismo \ensuremath{\Varid{sierpinski}}, vamos correr \ensuremath{\Varid{teste}\mathrel{=}\Varid{desenha}\;(\Varid{sierpinski}\;(\Varid{base},\mathrm{4}))} e verificar se o triângulo gerado é de facto igual à figura 2:
...
\begin{eqnarray*}
     \xymatrix@C=1cm@R=2cm{
         Bit^*
         \ar[d]_{\ensuremath{\cataList{\Varid{gf}}}}
         \ar@/^1.5pc/[rr]^(0.5){outList} 
     & 
          \cong
     &
         1 + Bit \ensuremath{\times} Bit^*
                \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\cataList{\Varid{gf}}}}
                \ar@/^1.5pc/[ll]^(0.5){inList}
     \\
          D(Bit^*) && 1 + Bit \ensuremath{\times} D(Bit^*)
          \ar[ll]
     }
\end{eqnarray*}


Assim sendo, a função \ensuremath{\Varid{propagate}} é um catamorfismo de g e f. Ora, em g temos a divisão em dois casos, o caso em que lista inicial é vazia, e o caso em que é diferente de vazia, em que passaremos a função \ensuremath{\Varid{f}}, a uma nova função \ensuremath{g_2 }. ~
Nesta função, criámos o \ensuremath{\Varid{m}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]}, ou seja, dentro de um \ensuremath{\mathbf{do}}, vamos aplicar f a cada elemento da lista, do tipo a, retornando no final um monade de uma lista de a's. 
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}g_2 \;\Varid{f}\;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{h}\leftarrow \Varid{f}\;\Varid{a};\Varid{t}\leftarrow \Varid{b};\Varid{return}\;(\Varid{cons}\;(\Varid{h},\Varid{t}))\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks


Tomando como "inspiração" a função \ensuremath{\Varid{propagate}} inicial, a função \ensuremath{\Varid{propagate3}} será definida da mesma forma através do \ensuremath{\cataList{\Varid{gf}}}. Seguindo o mesmo pensamento, a função g também terá a mesma definição, existindo apenas diferenças na função g2. 
Uma vez que será esta que criará um \ensuremath{\Varid{m}\;[\mskip1.5mu \Conid{Bit}\mskip1.5mu]}, a partir de um lista de \ensuremath{\Conid{Bit}} que não é vazia. Assim sendo, temos de pegar em cada lista, e passá-lo à função f, dada como argumento. No entanto, esta recebe como argumento um \ensuremath{\Conid{Bit3}}, pelo que teremos de criar um triplo com o elemento da lista. 
Finalmente, "pegamos" nos restantes elementos da lista, dada como argumento, e iremos criar um \ensuremath{\Varid{m}\;[\mskip1.5mu \Conid{Bit}\mskip1.5mu]}. 
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}g_2 \;\Varid{f}\;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{h}\leftarrow \Varid{f}\;(\Varid{a},\Varid{a},\Varid{a});\Varid{t}\leftarrow \Varid{b};{}\<[46]%
\>[46]{}\Varid{return}\;(\Varid{cons}\;(v_3 \;(\Varid{h}),\Varid{t}))\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks


Temos que a função \ensuremath{\Varid{bflip3}}, que recebe como argumento um \ensuremath{\Conid{Bit3}}, pretende estender a função já definida, anteriormente, \ensuremath{\Varid{bflip}} aos três \ensuremath{\Conid{Bit}} existintes no \ensuremath{\Conid{Bit3}} argumento. Assim sendo, teremos que, num do, aplicar \ensuremath{\Varid{bflip}} a cada elemento do tuplo e posteriormente returnar o triplo constituiente com as três aplicações do \ensuremath{\Varid{bflip}}. Da seguinte forma, 
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{bflip3}\mathbin{::}\Conid{Bit3}\to \fun{Dist}\;\Conid{Bit3}{}\<[E]%
\\
\>[B]{}\Varid{bflip3}\;(\Varid{a},\Varid{b},\Varid{c})\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{h}\leftarrow (\Varid{bflip}\;(\Varid{a}));\Varid{t}\leftarrow (\Varid{bflip}\;(\Varid{b}));\Varid{x}\leftarrow (\Varid{bflip}\;(\Varid{c}));\Varid{return}\;(\Varid{h},\Varid{t},\Varid{x})\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
