...
\begin{eqnarray*}
     \xymatrix@C=2cm{
         \ensuremath{\Conid{Ltree}\;\Conid{Int}}
                ...
                \ar[d]_-{\ensuremath{\cataNat{\Varid{g}}}}
     &
         \ensuremath{\mathrm{1}\mathbin{+}\Conid{Int}\times\Conid{Ltree}\;\Conid{Int}}
                \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{g}}}
                \ar[l]_-{\ensuremath{\mathbf{in}}}
     \\
          \ensuremath{\Conid{Int}\times\Conid{Int}}
     &
          \ensuremath{\mathrm{1}\mathbin{+}\Conid{Int}\times\Conid{Int}}
                \ar[l]^-{\ensuremath{\alt{\Varid{g11}}{\Varid{g12}}}}
     }
     \end{eqnarray*}
...
\begin{eqnarray*}
     \xymatrix@C=2cm{
         \ensuremath{\Conid{Ltree3}\;\Conid{A}}
                \ar[r]^{\ensuremath{\Varid{out}}}
                \ar[d]_-{\ensuremath{\Varid{cataLTree3}\;\Varid{f}}}
     &
         \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times\Conid{Ltree3}\;\Conid{A}}
                \ar[d]^{\ensuremath{\Varid{recLTree3}\;(\Varid{cataLtree3}\;\Varid{f})}}
                \ar[l]_-{\ensuremath{\mathbf{in}}}
     \\
          \ensuremath{\Conid{A}}
     &
