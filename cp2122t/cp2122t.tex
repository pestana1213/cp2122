...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}g_1 \mathrel{=}(\Varid{singl}\mathbin{`\Varid{either}`}(\mathsf{conc}\comp (\Varid{id}\times\mathsf{conc})))\mbox{\onelinecomment where conc' (l1,(l2,l3)) = l1++l2++l3}{}\<[E]%
\\
\>[B]{}g_2 \;(((\Varid{x},\Varid{y}),\Varid{s}),\Varid{n})\mid \Varid{n}\equiv \mathrm{0}\mathrel{=}i_1\;((\Varid{x},\Varid{y}),\Varid{s}){}\<[E]%
\\
\>[B]{}\hsindent{32}{}\<[32]%
\>[32]{}\mid \Varid{otherwise}\mathrel{=}i_2\;((((\Varid{x},\Varid{y}),\Varid{s'}),\Varid{n'}),((((\Varid{x}\mathbin{+}\Varid{s'},\Varid{y}),\Varid{s'}),\Varid{n'}),(((\Varid{x},\Varid{y}\mathbin{+}\Varid{s'}),\Varid{s'}),\Varid{n'}))){}\<[E]%
\\
\>[32]{}\hsindent{4}{}\<[36]%
\>[36]{}\mathbf{where}\;\Varid{s'}\mathrel{=}\Varid{s}\div \mathrm{2}{}\<[E]%
\\
\>[36]{}\hsindent{6}{}\<[42]%
\>[42]{}\Varid{n'}\mathrel{=}\Varid{pred}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
