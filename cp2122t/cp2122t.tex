...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{anaLTree3}\;\Varid{f}\mathrel{=}\Varid{inLTree3}\comp (\Varid{recLTree3}\;(\Varid{anaLTree3}\;\Varid{f}))\mathbin{·}\Varid{f}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks


Ora, sabemos que um hilomorfismo é a composição de catamorfismo, após um anamorfismo. Logo, o hilomorfismo \ensuremath{\Varid{sierpinski}\mathrel{=}\Varid{folhasSierp}\mathbin{·}\Varid{geraSierp}}, caracteriza-se da seguinte forma:
\begin{eqnarray*}
     \xymatrix@C=2cm@R=2cm{
         \ensuremath{\Conid{Tri}\times\N_0}
...
\column{6}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}g_1 \mathrel{=}(\Varid{singl}\mathbin{`\Varid{either}`}(\mathsf{conc}\comp (\Varid{id}\times\mathsf{conc})))\;\mathbf{where}\;\Varid{conc'}\;(l_1 ,(l_2 ,\Varid{l3}))\mathrel{=}l_1 \mathbin{+\!\!\!+}l_2 \mathbin{+\!\!\!+}\Varid{l3}{}\<[E]%
\\
