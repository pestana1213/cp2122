...
\begin{eqnarray*}
     ...
     \ensuremath{\for{\Varid{g}\;\Varid{d}}\ {\mathrm{0},(\mathrm{0},\Varid{d})}\;\mathbf{where}\;(\Varid{g}\;\Varid{d})\;(\Varid{q},(\Varid{r},\mathrm{0}))\mathrel{=}(\Varid{g}\;\Varid{d})\;(\Varid{q},(\Varid{r},\Varid{c}\mathbin{+}\mathrm{1}))\mathrel{=}}
     \qed
\end{eqnarray*}
