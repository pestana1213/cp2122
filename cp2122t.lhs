...
\begin{eqnarray*}
     ...
     %
            g .  F |(split (alice) (bob))| = |(split (alice . in) (bob . in))|
     %
     \just\equiv{Universal-$\times$ (6)}
     %
     |lcbr(
          p1 . g .  F(split (alice) (bob)) = alice . in
     )(
          p2 . g .  F(split (alice) (bob)) = bob . in
     )|
     %
     \just\equiv{Fokkinga (52)}
     %
          |cata(split (p1 .g) (p2.g))|  = | (split (alice) (bob))|
     %
     \qed
\end{eqnarray*}
